...
import { NewCodeConfirmed } from "../../services/AuthAPI";
...
export default function RequestNewCode() {
    ...
    const handleRequestCode = (formData: RequestConfirmationCodeForm) => mutation.mutate(formData)
