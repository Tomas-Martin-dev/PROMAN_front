...
export default function ChangePasswordView() {
  ...
  const {reset, register, handleSubmit, watch, formState: { errors } } = useForm({ defaultValues: initialValues })
      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <input
            ...
            className="bg-fuchsia-600 w-full p-3 rounded-sm text-white uppercase font-semibold hover:bg-fuchsia-700 cursor-pointer transition-colors"
          />
        </form>
      </div>
    </>
